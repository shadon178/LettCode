...
public class CountVowelStringsTest {
    ...
    public int countVowelStringsV2(int n) {
    ...
    public int countVowelStringsV3(int n) {
        return (n + 1) * (n + 2) * (n + 3) * (n + 4) / 24;
    }

    @Test
    public void testCountVowelStrings() {
        Assert.assertEquals(5, countVowelStringsV1(1));
        Assert.assertEquals(15, countVowelStringsV1(2));
        Assert.assertEquals(66045, countVowelStringsV1(33));
    }
